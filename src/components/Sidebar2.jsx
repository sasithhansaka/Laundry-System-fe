...
export const Sidebar2 = ({ setSelectedComponent }) => {
    ...
    return (
        <>
            ...
            <aside id="cta-button-sidebar"
                   ...
                   aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[#70008C]">
                        ...
                        <li onClick={() => handleTabChange("FaqService", 2)}>
                            <a href="#"
                               className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">FAQ / Service</span>
                                {selectedTab === 2 &&
                                    <span
                                        className="inline-flex items-center justify-center  rounded-full dark:bg-transparent ">
                                        <svg className="allign left" width="10" height="16" viewBox="0 0 10 16"
                    ...
                    <div id="dropdown-cta" className="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-white/15" role="alert">
                        <div className="flex items-center mb-3">
                            ...
                            <button type="button"
                                    className="ms-auto -mx-1.5 -my-1.5 bg-transparent inline-flex justify-center items-center w-6 h-6 text-white rounded-lg focus:ring-2 focus:ring-blue-400 p-1 hover:bg-[#70008C]  dark:hover:bg-[#70008C]"
                        ...
                        <p className="mb-3 text-sm text-gray-300">
                            Turn on Your Browser Notifications to get instant updates of Orders and Etc.
                        </p>
                        <a className="text-sm text-blue-50 underline font-medium hover:text-blue-900 dark:hover:text-blue-300"
                           href="#">Learn More</a>
                    </div>
